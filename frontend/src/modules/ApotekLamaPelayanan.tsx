...
// laporan penuh. Dua instance ditumpuk: "Hari Ini" (default backend,
// tgl1=tgl2=hari ini) dan "Bulan Ini" (tgl1=tanggal 1 bulan berjalan,
// tgl2=hari ini) — sama endpoint, beda rentang tanggal.
//
...
type LamaPelayananDiagramProps = {
  title: string;
  tgl1?: string;
  tgl2?: string;
  emptyMessage: string;
...
const LamaPelayananDiagram: React.FC<LamaPelayananDiagramProps> = ({ title, tgl1, tgl2, emptyMessage }) => {
  const [summary, setSummary] = React.useState<LamaPelayananSummary | null>(null);
...
export const ApotekLamaPelayananView: React.FC = () => {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <LamaPelayananDiagram title="Hari Ini" emptyMessage="Tidak ada resep dengan validasi & penyerahan lengkap hari ini" />
      <LamaPelayananDiagram title="Bulan Ini" tgl1={tgl1BulanIni} tgl2={tgl2} emptyMessage="Tidak ada resep dengan validasi & penyerahan lengkap bulan ini" />
