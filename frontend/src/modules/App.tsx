...
import { TarifPelayananView } from './TarifPelayanan';
...
export const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (activeMenu) {
      ...
      case 'tarif-pelayanan':
        // Layout sendiri (sidebar + full layar), lepas dari shell aplikasi
        // sepenuhnya — persis pola ApotekView/KepegawaianView.
        return (
          <div style={{ position: 'fixed', inset: 0, zIndex: 9999, background: '#f3f4f6', overflow: 'hidden' }}>
            <TarifPelayananView onBack={() => setActiveMenu('menu-utama')} />
          </div>
        );
      case 'laporan':
        return (
