      ...
      <aside style={{
        ...
        <div style={{ padding: '20px 16px', background: 'linear-gradient(135deg, #1AB1E5 0%, #0891B2 100%)', display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ width: 56, height: 56, background: 'rgba(255,255,255,0.2)', backdropFilter: 'blur(10px)', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', border: '2px solid rgba(255,255,255,0.3)', flexShrink: 0 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ fontSize: 15, fontWeight: 700, color: '#fff', marginBottom: 4, whiteSpace: 'normal', wordBreak: 'break-word' }}>{patient.nm_pasien}</div>
        ...
        <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16, background: '#f9fafb' }}>
          ...
          <div style={{ background: '#fff', borderRadius: 12, padding: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.05)', border: '1px solid #e5e7eb' }}>
            ...
            <div style={{ display: 'grid', gap: 12 }}>
              <InfoItem
                label="Jenis Kelamin"
                value={patient.jk === 'L' ? 'Laki-laki' : patient.jk === 'P' ? 'Perempuan' : patient.jk || '-'}
              ...
              <InfoItem
                ...
                value={`${patient.tmp_lahir ? `${patient.tmp_lahir}, ` : ''}${patient.tgl_lahir ? new Date(patient.tgl_lahir).toLocaleDateString('id-ID', { day: 'numeric', month: 'long', year: 'numeric' }) : '-'}${patient.umur ? ` (${patient.umur})` : ''}`}
