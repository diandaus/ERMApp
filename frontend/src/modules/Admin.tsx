...
const BRIDGING_DEFS: ServiceDef[] = [
  ...
  },
  {
    ...
    fields: [
      { key: 'CLIENTIDSATUSEHAT', label: 'Client ID', type: 'text' },
      { key: 'SECRETKEYSATUSEHAT', label: 'Secret Key', type: 'secret' },
      { key: 'URLAUTHSATUSEHAT', label: 'URL Auth', type: 'url', placeholder: 'https://api-satusehat.kemkes.go.id/oauth2/v1' },
      { key: 'URLFHIRSATUSEHAT', label: 'URL FHIR', type: 'url', placeholder: 'https://api-satusehat.kemkes.go.id/fhir-r4/v1' },
      { key: 'IDSATUSEHAT', label: 'Organization ID', type: 'text' },
      { key: 'KELURAHANSATUSEHAT', label: 'Kode Kelurahan', type: 'text' },
      { key: 'KECAMATANSATUSEHAT', label: 'Kode Kecamatan', type: 'text' },
      { key: 'KABUPATENSATUSEHAT', label: 'Kode Kabupaten', type: 'text' },
      { key: 'PROPINSISATUSEHAT', label: 'Kode Provinsi', type: 'text' },
      { key: 'KODEPOSSATUSEHAT', label: 'Kode Pos', type: 'text' },
    ],
  },
  {
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: 13 }}>
                <thead>
                  <tr style={{ background: '#f9fafb', borderBottom: '1px solid #e5e7eb' }}>
                    ...
                    <th style={{ padding: '12px 16px', textAlign: 'left', fontWeight: 600, color: '#374151' }}>Kode Dokter</th>
                ...
                <tbody>
                  {users.map((u) => (
                    <tr key={u.id} style={{ borderBottom: '1px solid #e5e7eb' }}>
                      ...
                      <td style={{ padding: '12px 16px', color: u.kd_dokter ? '#111827' : (u.role === 'dokter' ? '#dc2626' : '#9ca3af'), fontStyle: u.kd_dokter ? 'normal' : 'italic' }}>
                        {u.kd_dokter || 'Belum di-link'}
                      </td>
                  ...
                  {users.length === 0 && !loading && (
                    <tr>
                      <td colSpan={8} style={{ padding: '24px 8px', textAlign: 'center', color: '#9ca3af', borderTop: '1px solid #e5e7eb' }}>
