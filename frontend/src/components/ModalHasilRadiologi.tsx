              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
                ...
                <div style={{ position: 'relative', flex: 1 }}>
                  <textarea
                    ...
                    style={{ minHeight: 240, width: '100%', height: '100%', padding: '10px 12px 40px', border: '1px solid #d1d5db', borderRadius: 8, fontSize: 13, boxSizing: 'border-box', outline: 'none', resize: 'vertical', fontFamily: 'inherit' }}
                  />
                <div style={{ position: 'absolute', bottom: 8, right: 8, display: 'flex', alignItems: 'center', gap: 2, background: 'rgba(255,255,255,0.92)', borderRadius: 8 }}>
                  <button
                    type="button"
                  ...
                  <button
                    ...
                    style={{ padding: '9px 12px', borderRadius: 8, border: 'none', background: 'transparent', color: signing ? '#9ca3af' : '#374151', cursor: signing ? 'default' : 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                  >
